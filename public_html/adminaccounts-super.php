                                    ...
                                    <div class ="bar">
                                        <div class ="bar-line">
                                            <div class="bar-display">
                                                <a href = "adminaccounts-super.php">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        if (isset($_POST['searchbutton'])) {
                                            if ($_POST['search'] == null) {
                                                ...
                                                if ($_POST['option'] == "all") {
                                                    $q = "SELECT * FROM adminaccounts WHERE IDN LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%' OR FirstName LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%' OR LastName LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%' OR Email LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%' OR AccountStatus LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%'";
                                                    ...
                                                    $q = "SELECT * FROM adminaccounts WHERE IDN LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%'  ORDER BY IDN ASC";
                                                    $query7 = mysqli_query($lib, $q);
                                                    if ($query7) {
                                                    ...
                                                    $q = "SELECT * FROM adminaccounts WHERE FirstName LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%'  ORDER BY FirstName ASC";
                                                    $query7 = mysqli_query($lib, $q);
                                                    if ($query7) {
                                                    ...
                                                    $q = "SELECT * FROM adminaccounts WHERE LastName LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%'  ORDER BY LastName ASC";
                                                    $query7 = mysqli_query($lib, $q);
                                                    if ($query7) {
                                                    ...
                                                    $q = "SELECT * FROM adminaccounts WHERE Email LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%'  ORDER BY Email ASC";
                                                    $query7 = mysqli_query($lib, $q);
                                                    if ($query7) {
                                                    ...
                                                    $q = "SELECT * FROM adminaccounts WHERE AccountStatus LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%'  ORDER BY AccountStatus ASC";
                                                    $query7 = mysqli_query($lib, $q);
                                                    if ($query7) {
                                            ...
                                            if ($result = mysqli_query($lib, $query)){
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    <div id="changeinfo" class="overlay">
                                                        <div class="popup">
                                                            <form action="adminaccounts-super.php"><a class="close" href="adminaccounts-super.php">&times;</a></form>
                                                            <br><br>
                                                                ...
                                                                <form method="post">
                                                                    ...
                                                                    if (isset($_POST['submit'])) {
                                                                        if ($_POST['idn1'] == $row['IDN']) {
                                                                            ...
                                                                            echo "<script>location='http://order-com.stackstaging.com/adminaccounts-super.php#changeinfos'</script>";
                                                                        } else {
                                        ...
                                        <div id="deactivate" class="overlay">
                                            <div class="popup">
                                                <form action="adminaccounts-super.php" method="post"><a class="close" href="adminaccounts-super.php" name="refresh">&times;</a></form>
                                                <br><br>
                                                <div class="content" align="center">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        if (isset($_POST['deactivate'])) {
                                                            if ($_POST['deactivate'] == "Confirm") {
                                                                $select = "SELECT * FROM adminaccounts WHERE IDN ='" . mysqli_real_escape_string($lib, $_POST['idn']) . "' AND AccountStatus ='Active'";
                                                                $result = mysqli_query($lib, $select);
                                                                $idnum = $_POST['idn'];
                                                                $check = preg_match('/^[0-9]+$/', $idnum);
                                                                if ($check) {
                                                                    if (mysqli_num_rows($result) > 0) {
                                                                        $deactivate = "UPDATE adminaccounts SET AccountStatus ='Inactive' WHERE IDN ='" . mysqli_real_escape_string($lib, $_POST['idn']) . "'";
                                                                        if (mysqli_query($lib, $deactivate)) {
                                                                            echo "<br><p align='center'><font color = '#177a03'>Account successfully deactivated</font></p>";
                                                                        }
                                                                    } else {
                                                                        $select = "SELECT * FROM adminaccounts WHERE IDN ='" . mysqli_real_escape_string($lib, $_POST['idn']) . "' AND AccountStatus ='Inactive'";
                                                                        $result = mysqli_query($lib, $select);
                                                                        if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        if (isset($_POST['activate'])) {
                                                            if ($_POST['activate'] == "Confirm") {
                                                                ...
                                                                if ($check) {
                                                                    if (mysqli_num_rows($result) > 0) {
                                                                        $deactivate = "UPDATE adminaccounts SET AccountStatus ='Active' WHERE IDN ='" . mysqli_real_escape_string($lib, $_POST['idn']) . "'";
                                                                        if (mysqli_query($lib, $deactivate)) {
                                                        ...
                                                        if ($_POST['change'] == "Confirm") {
                                                            if ($_POST['idn'] == null && $_POST['firstname'] == null && $_POST['lastname'] == null && $_POST['Email'] == null) {
                                                                ...
                                                                if ($_POST['firstname'] != null) {
                                                                    ...
                                                                    $select = "SELECT * FROM adminaccounts WHERE IDN ='" . mysqli_real_escape_string($lib, $_SESSION['idn1']) . "'";
                                                                    $result = mysqli_query($lib, $select);
                                                                    if (mysqli_num_rows($result) > 0 && $check) {
                                                                        $change = "UPDATE adminaccounts SET FirstName='" . mysqli_real_escape_string($lib, $_POST['firstname']) . "' WHERE IDN ='" . mysqli_real_escape_string($lib, $_SESSION['idn1']) . "'";
                                                                        if (mysqli_query($lib, $change)) {
                                                                            $success1 = "<p align='center'><font color = '#177a03'>First name successfully changed</font></p>";
                                                                        }
                                                                    } else if (!$check) {
                                                                ...
                                                                if ($_POST['lastname'] != null) {
                                                                    ...
                                                                    $result = mysqli_query($lib, $select);
                                                                    if (mysqli_num_rows($result) > 0 && $check) {
                                                                        $change = "UPDATE adminaccounts SET LastName='" . mysqli_real_escape_string($lib, $_POST['lastname']) . "' WHERE IDN ='" . mysqli_real_escape_string($lib, $_SESSION['idn1']) . "'";
                                                                        if (mysqli_query($lib, $change)) {
                                                                            $success2 = "<p align='center'><font color = '#177a03'>Last name successfully changed</font></p>";
                                                                        }
                                                                    } else if (!$check) {
                                                                ...
                                                                if ($_POST['Email'] != null) {
                                                                    $select = "SELECT * FROM adminaccounts WHERE IDN ='" . mysqli_real_escape_string($lib, $_SESSION['idn1']) . "'";
                                                                    $result = mysqli_query($lib, $select);
                                                                    $validate = "SELECT * FROM adminaccounts WHERE Email ='" . mysqli_real_escape_string($lib, $_POST['Email']) . "'";
                                                                    ...
                                                                    if (mysqli_num_rows($result) > 0) {
                                                                        if (mysqli_num_rows($resval) > 0) {
                                                                            ...
                                                                            if (!(preg_match("/\b" . $ust . "\b/i", $_POST['Email']))) {
                                                                                ...
                                                                                $change = "UPDATE adminaccounts SET Email='" . mysqli_real_escape_string($lib, $_POST['Email']) . "' WHERE IDN ='" . mysqli_real_escape_string($lib, $_SESSION['idn1']) . "'";
                                                                                if (mysqli_query($lib, $change)) {
                                                                ...
                                                                if ($_POST['idn'] != null) {
                                                                    ...
                                                                    $select = "SELECT * FROM adminaccounts WHERE IDN ='" . mysqli_real_escape_string($lib, $_SESSION['idn1']) . "'";
                                                                    $result = mysqli_query($lib, $select);
                                                                    $validate = "SELECT * FROM adminaccounts WHERE IDN  ='" . mysqli_real_escape_string($lib, $_POST['idn']) . "'";
                                                                    $resval = mysqli_query($lib, $validate);
                                                                    if (mysqli_num_rows($result) > 0 && $check) {
                                                                        if (mysqli_num_rows($resval) > 0) {
                                                                            $taken2 = "<p align='center'><font color = '#fc1616'>ID number is already used</font></p>";
                                                                        } else {
                                                                            $change = "UPDATE adminaccounts SET IDN ='" . mysqli_real_escape_string($lib, $_POST['idn']) . "' WHERE IDN ='" . mysqli_real_escape_string($lib, $_SESSION['idn1']) . "'";
                                                                            if (mysqli_query($lib, $change)) {
                    ...
                    if (isset($_POST['signup'])) {
                        if (array_key_exists('idn', $_POST) AND array_key_exists('lastname', $_POST) AND array_key_exists('firstname', $_POST) AND array_key_exists('email', $_POST) AND array_key_exists('password', $_POST)) {
                            if (mysqli_connect_error()) {
                                ...
                                $query = "SELECT * FROM adminaccounts WHERE IDN = '" . mysqli_real_escape_string($lib, $_POST['idn']) . "' OR  Email = '" . mysqli_real_escape_string($lib, $_POST['email']) . "'";
                                ...
                                if ($checkfname && $checklname && $checkidnum && $checkemail) {
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        $queryinsert = "INSERT INTO adminaccounts(IDN, LastName, FirstName, Email, Password) VALUES ('" . mysqli_real_escape_string($lib, $_POST['idn']) . "', '" . mysqli_real_escape_string($lib, $_POST['lastname']) . "','" . mysqli_real_escape_string($lib, $_POST['firstname']) . "', '" . mysqli_real_escape_string($lib, $_POST['email']) . "', '" . mysqli_real_escape_string($lib, md5($_POST['password'])) . "')";
