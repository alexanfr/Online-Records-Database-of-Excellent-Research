    ...
    <html lang="en">
        ...
        <body class="sb-nav-fixed">
            ...
            <nav class="container-floater">
                ...
                <div class="floating-action-btn"><i class="fas fa-ellipsis-v my-float-accounts"></i></div>
                                   ...
                                   <div id="delete" class="overlay">
                                                    <div class="popup">
                                                        <form action="archive-super.php"><a class="close" href="archive-super.php">&times;</a></form>
                                                        <br><br>
                                                                ...
                                                                <br> <br>
                                                                 ...
                                                                 if(isset($_POST['confirm'])){
                                                                     if($_POST['confirm'] == "On-going research"){
                                                                         echo "<script>location='http://order-com.stackstaging.com/archive-super.php#ongoing'</script>";
                                                                         
                                                                     }else{
                                                                         echo "<script>location='http://order-com.stackstaging.com/archive-super.php#completed'</script>";
                                                                     }
                                                                 }
                                                                 ?>
                                                                <br>
                                                            ...
                                                            <form method="post">
                                                                ...
                                                                if (isset($_POST['delete'])) {
                                                                    ...
                                                                    if (mysqli_num_rows($result) > 0) {
                                                                            ...
                                                                            echo "<script>location='http://order-com.stackstaging.com/archive-super.php#confirmdelete1'</script>";
                                                                    } else {
                                                            ...
                                                            <form method="post">
                                                                ...
                                                                if (isset($_POST['delete'])) {
                                                                    ...
                                                                    if (mysqli_num_rows($result) > 0) {
                                                                            ...
                                                                            echo "<script>location='http://order-com.stackstaging.com/archive-super.php#confirmdelete2'</script>";
                                    ...
                                    while ($recent = mysqli_fetch_array($result1)) {
                                        if (isset($_COOKIE["cookie"])) {
                                                    if ($recent['Title'] == $_COOKIE["cookie"]){ 
                                                        echo "<script>location='http://order-com.stackstaging.com/archive-super.php#abstract'</script>";
                                                    }
            ...
            <div id="abstract" class="overlay">
                <div class="popup-small">
                    <a class="close" href="archive-super.php#opt2">&times;</a>
                    <br><br>
                    <div class="content" align="center">
                        <h2>Abstract</h2>
                        <br>
