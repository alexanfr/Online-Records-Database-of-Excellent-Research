        ...
        <body class="sb-nav-fixed">
            ...
            <div id="opt2" class="overlay">
                <div class="popup-small">
                    <form action="library-super.php"><a class="close" href="library-super.php">&times;</a></form>
                    <br><br>
                                    ...
                                    while ($recent = mysqli_fetch_array($validatelatest)) {
                                        if (isset($_COOKIE["cookie"])) {
                                                ...
                                                if ($result = mysqli_query($lib, $query)) {
                                                    ...
                                                    echo "<script>location='http://order-com.stackstaging.com/library-super.php#abstract'</script>";
                                                    }
                                                }                                                
                                        }
                                    }
