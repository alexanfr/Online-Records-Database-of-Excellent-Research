    ...
    color: #000000;
        ...
        <body class="sb-nav-fixed">
                                        ...
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            if (isset($_POST['searchbutton'])) {
                                                ...
                                                <div id="delete" class="overlay">
                                                    <div class="popup">
                                                        <form action="myclass.php"><a class="close" href="myclass.php">&times;</a></form>
                                                        <br><br>
                                    ...
                                    while ($recent = mysqli_fetch_array($validatelatest)) {
                                        if (isset($_COOKIE["cookie"])) {
                                                ...
                                                if ($result = mysqli_query($lib, $query)) {
                                                    ...
                                                    echo "<script>location='http://order-com.stackstaging.com/myclass.php#abstract'</script>";
                                                    }
                                                }                                                
                                        }
                                    }
            ...
            <div id="abstract" class="overlay">
                <div class="popup-small">
                    <a class="close" href="myclass.php#opt2">&times;</a>
                    <br><br>
                    <div class="content" align="center">
                        <h2>Abstract</h2>
                        <br><br>
