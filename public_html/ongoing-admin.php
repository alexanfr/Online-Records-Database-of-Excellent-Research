    ...
    <html lang="en">
        ...
        <body class="sb-nav-fixed">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            if (isset($_POST['searchbutton'])) {
                                                ...
                                                echo"<table class='table table-bordered' width='100%' cellspacing='0'><th>Group Number</th><th>Date</th><th>Title</th><th>Members</th><th>Technical Adviser</th><th>Content Adviser</th><th>Category</th><th>Status</th>"; //table header
                                                while($recent = mysqli_fetch_array($validatelatest)){
                                                $query = "SELECT * FROM library WHERE Date ='".$recent['Date']."' AND Time='".$recent['Time']."' AND Status='On-going' ORDER BY Date DESC";
            ...
            <div id="delete" class="overlay">
                <div class="popup">
                    <form action="ongoing-admin.php"><a class="close" href="ongoing-admin.php">&times;</a></form>
                    <br><br>
                    <div class="content" align="center">
                                    ...
                                    while ($recent = mysqli_fetch_array($validatelatest)) {
                                        if (isset($_COOKIE["cookie"])) {
                                                ...
                                                if ($result = mysqli_query($lib, $query)) {
                                                    ...
                                                    echo "<script>location='http://order-com.stackstaging.com/ongoing-admin.php#abstract'</script>";
                                                    }
                                                }                                                
                                        }
                                    }
            ...
            <div id="abstract" class="overlay">
                <div class="popup-small">
                    <a class="close" href="ongoing-admin.php#opt2">&times;</a>
                    <br><br>
                    <div class="content" align="center">
                        <h2>Abstract</h2>
                        <br><br>
