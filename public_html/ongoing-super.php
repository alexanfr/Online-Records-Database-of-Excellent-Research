        ...
        <body class="sb-nav-fixed">
                                        ...
                                        <table class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            if (isset($_POST['searchbutton'])) {
                                                if ($_POST['search'] == null) {
                                                    ...
                                                    if ($_POST['option'] == "all") {
                                                        ...
                                                        $q = "SELECT * FROM library WHERE ( Status='On-going' AND Status LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%' AND Date ='".$recent['Date']."' AND Time='".$recent['Time']."')  OR (Status='On-going' AND Title LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%' AND Date ='".$recent['Date']."' AND Time='".$recent['Time']."') OR (Status='On-going' AND GroupNo LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%' AND Date ='".$recent['Date']."' AND Time='".$recent['Time']."') OR (Status='On-going' AND Date LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%' AND Date ='".$recent['Date']."' AND Time='".$recent['Time']."') OR (Status='On-going' AND `Technical Adviser` LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%' AND Date ='".$recent['Date']."' AND Time='".$recent['Time']."') OR (Status='On-going' AND `Content Adviser` LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%' AND Date ='".$recent['Date']."' AND Time='".$recent['Time']."') OR (Status='On-going' AND Category LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%' AND Date ='".$recent['Date']."' AND Time='".$recent['Time']."') OR (Status='On-going' AND Members LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%' AND Date ='".$recent['Date']."' AND Time='".$recent['Time']."') GROUP BY GroupNo";
                                                        ...
                                                        echo"<table class='table table-bordered' width='100%' cellspacing='0'><th>Group Number</th><th>Date</th><th>Title</th><th>Members</th><th>Technical Adviser</th><th>Content Adviser</th><th>Category</th><th>Status</th>"; //table header
                                                        while($recent = mysqli_fetch_array($validatelatest)){
                                                        $q = "SELECT * FROM library WHERE `Title` LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%' AND Date ='".$recent['Date']."' AND Time='".$recent['Time']."' AND Status='On-going' GROUP BY GroupNo";
                                                        $query7 = mysqli_query($lib, $q);
                                                        if ($query7) {
                                                            if (mysqli_num_rows($query7) > 0) {
                                                                while ($row = mysqli_fetch_array($query7)) {
                                                        ...
                                                        echo"<table class='table table-bordered' width='100%' cellspacing='0'><th>Group Number</th><th>Date</th><th>Title</th><th>Members</th><th>Technical Adviser</th><th>Content Adviser</th><th>Category</th><th>Status</th>"; //table header
                                                        while($recent = mysqli_fetch_array($validatelatest)){
                                                        $q = "SELECT * FROM library WHERE `Members` LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%' AND Date ='".$recent['Date']."' AND Time='".$recent['Time']."' AND Status='On-going' GROUP BY GroupNo";
                                                        $query7 = mysqli_query($lib, $q);
                                                        if ($query7) {
                                                            if (mysqli_num_rows($query7) > 0) {
                                                                while ($row = mysqli_fetch_array($query7)) {
                                                        ...
                                                        echo"<table class='table table-bordered' width='100%' cellspacing='0'><th>Group Number</th><th>Date</th><th>Title</th><th>Members</th><th>Technical Adviser</th><th>Content Adviser</th><th>Category</th><th>Status</th>"; //table header
                                                        while($recent = mysqli_fetch_array($validatelatest)){
                                                        $q = "SELECT * FROM library WHERE `GroupNo` LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%' AND Date ='".$recent['Date']."' AND Time='".$recent['Time']."' AND Status='On-going' GROUP BY GroupNo";
                                                        $query7 = mysqli_query($lib, $q);
                                                        if ($query7) {
                                                            if (mysqli_num_rows($query7) > 0) {
                                                                while ($row = mysqli_fetch_array($query7)) {
                                                        ...
                                                        echo"<table class='table table-bordered' width='100%' cellspacing='0'><th>Group Number</th><th>Date</th><th>Title</th><th>Members</th><th>Technical Adviser</th><th>Content Adviser</th><th>Category</th><th>Status</th>"; //table header
                                                        while($recent = mysqli_fetch_array($validatelatest)){
                                                        $q = "SELECT * FROM library WHERE `Date` LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%' AND Date ='".$recent['Date']."' AND Time='".$recent['Time']."' AND Status='On-going' GROUP BY GroupNo";
                                                        $query7 = mysqli_query($lib, $q);
                                                        if ($query7) {
                                                            if (mysqli_num_rows($query7) > 0) {
                                                                while ($row = mysqli_fetch_array($query7)) {
                                                        ...
                                                        echo"<table class='table table-bordered' width='100%' cellspacing='0'><th>Group Number</th><th>Date</th><th>Title</th><th>Members</th><th>Technical Adviser</th><th>Content Adviser</th><th>Category</th><th>Status</th>"; //table header
                                                        while($recent = mysqli_fetch_array($validatelatest)){
                                                        $q = "SELECT * FROM library WHERE `Content Adviser` LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%' AND Date ='".$recent['Date']."' AND Time='".$recent['Time']."' AND Status='On-going' GROUP BY GroupNo";
                                                        $query7 = mysqli_query($lib, $q);
                                                        if ($query7) {
                                                            if (mysqli_num_rows($query7) > 0) {
                                                                while ($row = mysqli_fetch_array($query7)) {
                                                        ...
                                                        echo"<table class='table table-bordered' width='100%' cellspacing='0'><th>Group Number</th><th>Date</th><th>Title</th><th>Members</th><th>Technical Adviser</th><th>Content Adviser</th><th>Category</th><th>Status</th>"; //table header
                                                        while($recent = mysqli_fetch_array($validatelatest)){
                                                        $q = "SELECT * FROM library WHERE `Technical Adviser` LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%' AND Date ='".$recent['Date']."' AND Time='".$recent['Time']."' AND Status='On-going' GROUP BY GroupNo";
                                                        $query7 = mysqli_query($lib, $q);
                                                        if ($query7) {
                                                            if (mysqli_num_rows($query7) > 0) {
                                                                while ($row = mysqli_fetch_array($query7)) {
                                                        ...
                                                        echo"<table class='table table-bordered' width='100%' cellspacing='0'><th>Group Number</th><th>Date</th><th>Title</th><th>Members</th><th>Technical Adviser</th><th>Content Adviser</th><th>Category</th><th>Status</th>"; //table header
                                                        while($recent = mysqli_fetch_array($validatelatest)){
                                                        $q = "SELECT * FROM library WHERE Category LIKE '%" . mysqli_real_escape_string($lib, $_POST['search']) . "%' AND Date ='".$recent['Date']."' AND Time='".$recent['Time']."' AND Status='On-going' GROUP BY GroupNo";
                                                        $query7 = mysqli_query($lib, $q);
                                                        if ($query7) {
                                                            if (mysqli_num_rows($query7) > 0) {
                                                                while ($row = mysqli_fetch_array($query7)) {
                                                ...
                                                echo"<table class='table table-bordered' width='100%' cellspacing='0'><th>Group Number</th><th>Date</th><th>Title</th><th>Members</th><th>Technical Adviser</th><th>Content Adviser</th><th>Category</th><th>Status</th>"; //table header
                                                while($recent = mysqli_fetch_array($validatelatest)){
                                                $query = "SELECT * FROM library WHERE Date ='".$recent['Date']."' AND Time='".$recent['Time']."' AND Status='On-going' GROUP BY GroupNo";
                                            ...
                                            ?>  
                                                  ...
                                                  <div id="changestatus" class="overlay">
                                                    <div class="popup">
                                                        <form action="ongoing-admin.php" method="post"><a class="close" href="ongoing-admin.php" name="refresh">&times;</a></form>
                                                        <br><br>
            ...
            <nav class="container-floater">
                <div class="floating-action-btn"><div class = "tooltip1"><a style='color: inherit;' href='#delete'><i class='fas fa-trash-alt my-float-accounts-1'></i></a>
                        <span class = "tooltiptext" style = "right: 250% !important"> Delete </span></div></div>
             ...
             <div id="delete" class="overlay">
                <div class="popup">
                    <form action="ongoing-super.php"><a class="close" href="ongoing-super.php">&times;</a></form>
                    <br><br>
                    <div class="content" align="center">
                            ...
                            if (isset($_POST['delete'])) {
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    if ($_POST['delete'] == "Confirm") {
                                        ...
                                        $drop = "UPDATE archive SET Status = 'Dropped' WHERE Title ='" . mysqli_real_escape_string($lib, $_POST['deletetitle']) . "' AND Date='". $row9['Date']."' AND Time='". $row9['Time']."' AND GroupNo='". $row9['GroupNo']."'";
                                        $droprun = mysqli_query($lib, $drop);
                                    ...
                                    while ($recent = mysqli_fetch_array($validatelatest)) {
                                        if (isset($_COOKIE["cookie"])) {
                                                ...
                                                if ($result = mysqli_query($lib, $query)) {
                                                    ...
                                                    echo "<script>location='http://order-com.stackstaging.com/ongoing-super.php#abstract'</script>";
                                                    }
                                                }                                                
                                        }
                                    }
            ...
            <div id="abstract" class="overlay">
                <div class="popup-small">
                    <a class="close" href="ongoing-super.php#opt2">&times;</a>
                    <br><br>
                    <div class="content" align="center">
                        <h2>Abstract</h2>
                        <br><br>
