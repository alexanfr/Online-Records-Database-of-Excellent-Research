        ...
        <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav">
                ...
                <div id="layoutSidenav_content">
                                    ...
                                    <div class ="bar">
                                        <div class ="bar-line">
                                            <div class="bar-display">
                                                <a href = "studentaccounts-super.php">
                                            ...
                                            if ($result = mysqli_query($lib, $query)){
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    <div id="changeinfo" class="overlay">
                                                        <div class="popup">
                                                            <form action="studentaccounts-super.php"><a class="close" href="studentaccounts-super.php">&times;</a></form>
                                                            <br><br>
                                                                ...
                                                                <form method="post">
                                                                    ...
                                                                    if (isset($_POST['submit'])) {
                                                                        if ($_POST['studentnum1'] == $row['StudentNum']) {
                                                                            ...
                                                                            echo "<script>location='http://order-com.stackstaging.com/studentaccounts-super.php#changeinfos'</script>";
                                                                        } else {
                                                        ...
                                                        <div id="deactivate" class="overlay">
                                                            <div class="popup">
                                                                <form action="studentaccounts-super.php" method="post"><a class="close" href="studentaccounts-super.php" name="refresh">&times;</a></form>
                                                                <br><br>
                                                                <div class="content" align="center">
                    ...
                    <!--<a href="#add" class="float-accounts" id="float-accounts-hover"><i class="fa fa-plus my-float-accounts"></i></a>-->
